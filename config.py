...
share_config = {'mode': 'training',
                'dataset': 'avenue',
                'img_size': (256, 256),
                'data_root': '/home/abnormal_detection/VoTrungHieu/ano_pred_cvpr2018_origin/Data/'}  # remember the final '/'
...
def update_config(args=None, mode=None):
    ...
    assert args.dataset in ('ped1', 'ped2', 'avenue', 'shanghaitech'), 'Dataset error.'
